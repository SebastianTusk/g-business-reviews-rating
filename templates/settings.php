            ...
            <table class="wp-list-table widefat fixed striped parameters">
                ...
                <tr id="parameter-view">
                    ...
                    <td class="description"><?php /* translators: %s: bookmark for limit parameter */
						echo sprintf(__('Enable the carousel for reviews. Active when reviews exist, the view is 1 or more and the view lower than the <a href="%s">limit</a>.', 'g-business-reviews-rating'), '#parameter-limit'); ?></td>
                ...
                <tr id="parameter-id">
                    ...
                    <td class="description"><?php /* translators: %s: bookmark for reviews */
						echo sprintf(__('Show a review or reviews by ID (see <a href="%s">Reviews</a>); listing order is preserved; use a comma separated list for two or more IDs.', 'g-business-reviews-rating'), '#reviews'); ?></td>
                ...
                <tr id="parameter-date">
                    ...
                    <td class="description"><?php /* translators: use local language version at php.net if available */
						_e('Choose how to display the review dates, either using the <a href="https://www.php.net/manual/en/datetime.format.php" class="components-external-link" target="_blank">PHP date</a>, relative text or to hide entirely. Actual review date may be an approximation if imported.', 'g-business-reviews-rating'); ?></td>
                ...
                <tr id="parameter-link-disable">
                    ...
                    <td class="description"><?php /* translators: 1: parameter value for switching author name in review listings, 2: parameter value for setting author details to appear inline in the review listings */
						echo sprintf(__('Disable some or all types of external links: <em>%1$s</em>, <em>%2$s</em> or <em>%3$s</em>; comma separated list accepted.', 'g-business-reviews-rating'), 'reviews', 'write review', 'author'); ?></td>
                ...
                <tr id="parameter-review-item-order">
                    ...
                    <td class="description"><?php /* translators: 1: parameter value for switching author name in review listings, 2: parameter value for setting author details to appear inline in the review listings, 3: list of available elements */
						echo sprintf(__('Change the ordering of each review item — review text can be set to appear at the top of each entry. Add <em>%1$s</em> to switch the author&rsquo;s avatar and name with stars and date. Add <em>%2$s</em> to set the author name, stars and date inline. Individual elements can be sorted and included using a comma separated list (e.g. <em>%3$s</em>).', 'g-business-reviews-rating'), 'author switch', 'inline', 'avatar, name, rating, date, review'); ?></td>
                ...
                <tr id="parameter-iterations">
                    ...
                    <td class="description"><?php /* translators: 1: bookmark for view parameter, 2: parameter for view, 3: bookmark for interval parameter, 4: parameter for interval */
						echo sprintf(__('Set the specific number of slides to play. Carousel must active with both parameters set: <a href="%1$s">%2$s</a> and <a href="%3$s">%4$s</a>.', 'g-business-reviews-rating'), '#parameter-view', 'view', '#parameter-interval', 'interval'); ?></td>
                    <td class="accepted"><span class="code">0</span>, <span class="code">1</span>, <span class="code">2</span>, &hellip;</td>
                    <td class="default"><span class="code">0</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                ...
                <tr id="parameter-loop">
                    ...
                    <td class="description"><?php /* translators: 1: number/text used for infinite loop, 2: boolean value used for infinite loop, 3: bookmark for view parameter, 4: parameter for view, 5: bookmark for interval parameter, 6: parameter for interval */
						echo sprintf(__('Specify the number of complete loops to automatically play through set of slides. Set to <span class="code">%1$s</span> or <span class="code">%2$s</span> for an infinite loop. Carousel must active with both parameters set: <a href="%3$s">%4$s</a> and <a href="%5$s">%6$s</a>.', 'g-business-reviews-rating'), '-1', 'TRUE', '#parameter-view', 'view', '#parameter-interval', 'interval'); ?></td>
              ...
              <tr id="class-light">
                ...
                <tr>
                  ...
                  <td class="description"><?php /* translators: 1: the English class name number two, 2: the English class name number three, 3: the English class name number four, 4: the English class name number five, 5: the English class name number six */
					echo sprintf(__('Place reviews into multiple columns using an accompanying class: %1$s, %2$s, %3$s, %4$s or %5$s.', 'g-business-reviews-rating'), 'two', 'three', 'four', 'five', 'six'); ?></td>
                  <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                  <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr>
